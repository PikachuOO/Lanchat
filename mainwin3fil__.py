...
pic1 = Image.open('buttnonsel.jpg')
pic2 = Image.open('buttnonline.jpg')
def findkey(dic, val):
    return [k for k, v in dic.iteritems() if v == val][0]    
class textbutton(threading.Thread):
    ...
    def run(self):
        if self.flag == '0':
           ...
           self.pic1 = Image.open('buttnonsel.jpg')
        draw = ImageDraw.Draw(pic)
        draw.text((30, 12), self.text, font=ImageFont.truetype('Twilight.ttf',20), fill='#00f')
        image = wx.EmptyImage(pic.size[0],pic.size[1])
...
class mainwin(wx.Frame):
    def __init__(self):
        ...
        for x in range(len(self.contacts)):
            b = buttons.GenBitmapButton(self.panel, x, textbutton('0', self.contacts[x]), pos=(5,(70*x)+5))
    ...
    def butonupdate(self, contact):
        ...
        self.buttlist[x] = buttons.GenBitmapButton(self.panel, i, textbutton('1', self.contacts[x]), pos=p)
        self.Refresh()
    ...
    def butoffupdate(self, contact):
        ...
        i = self.buttlist[x].GetId()
        self.buttlist[x].Destroy()
        self.buttlist[x] = buttons.GenBitmapButton(self.panel, textbutton('0', self.contacts[x]), pos=p)
        self.Refresh()
